...
<?php
    if (isset($_SESSION['verification_errors']) || isset($_SESSION['verification_messages'])) {
        if (isset($_SESSION['verification_errors']) && $_SESSION['verification_errors']) {
        ...
        if (isset($_SESSION['verification_messages']) && $_SESSION['verification_messages']) {
            foreach ($_SESSION['verification_messages'] as $message) {
